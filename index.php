        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="php/signup_handle.php" method="post">
                        <div class="mb-3">
                            <label for="name" class="form-label">Full Name</label>
                            <input type="text" required class="form-control" maxlength="20" name="name" id="name">
                        </div>
                        <div class="mb-3">
                            <label for="email" class="form-label">Email address</label>
                            <input type="email" required class="form-control" maxlength="50" name="email" id="email">
                        </div>
                        <div class="mb-3">
                            <label for="number" class="form-label">Phone Number</label>
                            <input type="number" required class="form-control" maxlength="11" name="number" id="number">
                        </div>
                        <div class="mb-3">
    ...
    <div class="modal fade" id="loginModal" tabindex="-1" aria-labelledby="loginModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="php/login_handle.php" method="post">
                        <div class="mb-3">
                            <label for="email" class="form-label">Email address</label>
                            <input type="email" required class="form-control" maxlength="50" name="email" id="email"
    ...
    <main id="main">
                            ...
                            while($row = mysqli_fetch_assoc($p_result)){
                                ...
                                <div class="col-md-3" style="margin: 25px;">
                                    <div class="card" style="width: 18rem;">
                                     <img src="uploads/'.$row['path'].'" class="card-img-top" alt="...">
                                        <div class="card-body">
                    ...
                    <div class="col-lg-8 d-flex align-items-center reservation-form-bg">
                        ...
                        ?>
                            ...
                            <div class="mb-3">
                                <?php
                                    if(isset($_GET['table']) && $_GET['table'] == "true"){
                                        echo '<div class="table-message">Your booking request was sent. We will call back or send an Email to confirm your reservation. Thank you!</div>';
                                    }elseif(isset($_GET['table']) && $_GET['table'] == "false"){
                                        echo '<div class="table-message">Your booking request was not sent. Because you already reserved your table. Thank you!</div>';
                                    }
                                ?>
                            ...
                            <?php
                                ...
                                if(isset($_SESSION['Loggedin']) && $_SESSION['Loggedin'] == "true"){
                                     echo'<div class="text-center"><button type="submit">Book a Table</button></div>';
                                }else{
                                    echo '<div class="table-message">First you login then You will book your table. Thank you!</div>';
                                }
        ...
        <section id="contact" class="contact">
            <div class="container" data-aos="fade-up">
                ...
                <form action="php/contact_handle.php" method="post" role="form" class="php-email-form-2 p-3 p-md-4">
                    <div class="row">
